...
///
/// **iOS v1.0 は広告なし**（CEO裁定 2026-07-15）＝`ads_platform_io` の `_adsSupported` で
/// iOS を除外するため、下記 [bannerUnitId] の iOS 分岐は現状呼ばれない（inert）。
/// iOS 広告は v1.1 で ATT 実装とともに実ユニットへ差し替える想定。
///

...
const List<MofiSpecies> kMofiSpeciesSeed = [
  MofiSpecies(id: 'slime_01', family: MofiFamily.slime, rarity: MofiRarity.common, name: 'ぷるりん', sortOrder: 1, evolvedName: 'プルリーナ'),
  MofiSpecies(id: 'slime_02', family: MofiFamily.slime, rarity: MofiRarity.common, name: 'もちすら', sortOrder: 2, evolvedName: 'モチェルラ'),
  MofiSpecies(id: 'slime_03', family: MofiFamily.slime, rarity: MofiRarity.rare, name: 'きらすら', sortOrder: 3, evolvedName: 'キラシュラ'),
  MofiSpecies(id: 'slime_04', family: MofiFamily.slime, rarity: MofiRarity.rare, name: 'にじすら', sortOrder: 4, evolvedName: 'ニジェーラ'),
  MofiSpecies(id: 'slime_05', family: MofiFamily.slime, rarity: MofiRarity.sr, name: 'しずくら', sortOrder: 5, evolvedName: 'シズクレア'),
  MofiSpecies(id: 'critter_01', family: MofiFamily.critter, rarity: MofiRarity.common, name: 'ころみ', sortOrder: 6, evolvedName: 'コロミア'),
  MofiSpecies(id: 'critter_02', family: MofiFamily.critter, rarity: MofiRarity.common, name: 'ぽてうさ', sortOrder: 7, evolvedName: 'ポテラビス'),
  MofiSpecies(id: 'critter_03', family: MofiFamily.critter, rarity: MofiRarity.rare, name: 'まめきつ', sortOrder: 8, evolvedName: 'マメキーネ'),
  MofiSpecies(id: 'critter_04', family: MofiFamily.critter, rarity: MofiRarity.rare, name: 'ふわりす', sortOrder: 9, evolvedName: 'フワリスタ'),
  MofiSpecies(id: 'critter_05', family: MofiFamily.critter, rarity: MofiRarity.ssr, name: 'こんこ', sortOrder: 10, evolvedName: 'コンルナ'),
  MofiSpecies(id: 'dragon_01', family: MofiFamily.dragon, rarity: MofiRarity.common, name: 'とかげり', sortOrder: 11, evolvedName: 'ドラゴウル'),
  MofiSpecies(id: 'dragon_02', family: MofiFamily.dragon, rarity: MofiRarity.rare, name: 'ほのり', sortOrder: 12, evolvedName: 'ヴォルグレア'),
  MofiSpecies(id: 'dragon_03', family: MofiFamily.dragon, rarity: MofiRarity.sr, name: 'らいむ', sortOrder: 13, evolvedName: 'ライゼクス'),
  MofiSpecies(id: 'dragon_04', family: MofiFamily.dragon, rarity: MofiRarity.sr, name: 'こおりん', sortOrder: 14, evolvedName: 'フリーゼル'),
  MofiSpecies(id: 'dragon_05', family: MofiFamily.dragon, rarity: MofiRarity.ssr, name: 'てんら', sortOrder: 15, evolvedName: 'セレスドラ'),
  // 獣（beast）＝“かっこいい”枠（男性ユーザー訴求 / 0007 で追加）。
  MofiSpecies(id: 'beast_01', family: MofiFamily.beast, rarity: MofiRarity.common, name: 'とらむ', sortOrder: 16, evolvedName: 'ヴァルガ'),
  MofiSpecies(id: 'beast_02', family: MofiFamily.beast, rarity: MofiRarity.common, name: 'うるが', sortOrder: 17, evolvedName: 'ウルガンド'),
  MofiSpecies(id: 'beast_03', family: MofiFamily.beast, rarity: MofiRarity.rare, name: 'レオン', sortOrder: 18, evolvedName: 'レオガルド'),
  MofiSpecies(id: 'beast_04', family: MofiFamily.beast, rarity: MofiRarity.sr, name: 'くろむ', sortOrder: 19, evolvedName: 'クロヴァルグ'),
  MofiSpecies(id: 'beast_05', family: MofiFamily.beast, rarity: MofiRarity.ssr, name: 'びゃくり', sortOrder: 20, evolvedName: 'ビャクレイヴ'),
];
